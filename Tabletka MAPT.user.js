...
(window.onload = function () {
    // простудный перечень
    let PLS = {
        1: ['АМИЗОН МАКС', 'капсулы 500мг N10', 'Минскинтеркапс', '14.05'], 2: ['АРПЕТОЛ', 'таблетки покрытые оболочкой 100мг N30', 'Лекфарм', '16.44'], 3: ['АРПЕТОЛ', 'таблетки покрытые оболочкой 50мг N30', 'Лекфарм', '6.86'],
    ...
    //перечень сердечных
    let SLS = {
        2: ['АМЛОДИПИН', 'таблетки 10мг N30', 'Лекфарм', '3.55'], 3: ['АМЛОДИПИН', 'таблетки 5мг N30', 'Фармлэнд', '5.07'], 4: ['АМЛЕССА', 'таблетки 8мг/10мг N30', 'КРКА', '29.64'],
    ...
    let BKC = {
        1: ['АЗИТРОМИЦИН', 'таблетки покрытые оболочкой 500мг N6', 'Фармлэнд', '18.42'], 2: ['ЛЮГЕЛЬ', 'суспензия для приема внутрь 170мл', 'Фармлэнд', '7.89'], 3: ['АМБРОКСОЛ', 'таблетки 30мг N20', 'Борисовский ЗМП', '1.29'],
